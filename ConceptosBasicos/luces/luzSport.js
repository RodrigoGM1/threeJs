...
function main(){
    ...
    const luz = new THREE.SpotLight(color, intencidad);
    ...
    gui.add(new DegReadHelper(luz, 'angle'), 'value', 0, 90).name('angle').onChange(updateLuz);
    gui.add(luz, 'penumbra', 0, 1, 0.01);
